...
import com.devotion.blue.web.wechat.WechatApi;
import com.devotion.blue.web.wechat.WechatApiConfigInterceptor;
import com.devotion.blue.web.wechat.WechatConsts;
...
public class _WechatController extends JBaseCRUDController<Content> {
	...
	public void menu() {
		...
		List<Content> wechat_menulist = new ArrayList<>();
