...
public class CommonPropertyDeferLoadError {
	...
	public static void initDatabase() throws Exception {
		...
		try {
			...
			Reader reader = Resources
					.getResourceAsReader("org/apache/ibatis/submitted/deferload_common_property/CreateDB.sql");
			...
			reader = Resources.getResourceAsReader(
					"org/apache/ibatis/submitted/deferload_common_property/lazyLoadIbatisConfig.xml");
	...
	public void testDeferLoadAfterResultHandler() {
		...
		try {
			class MyResultHandler implements ResultHandler<Object> {
