...
public class IncludeTest {
	...
	public void testIncludes() throws Exception {
		...
		try {
			final Integer result = sqlSession
					.selectOne("org.apache.ibatis.submitted.includes.mapper.selectWithProperty");
	...
	public void testParametrizedIncludes() throws Exception {
		final SqlSession sqlSession = sqlSessionFactory.openSession();
		try {
			final Map<String, Object> result = sqlSession
					.selectOne("org.apache.ibatis.submitted.includes.mapper.select");
			Assert.assertEquals(Integer.valueOf(1), result);
		} finally {
			sqlSession.close();
		}
