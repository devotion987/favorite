...
public class BindingTest {
	...
	public void shouldCacheMapperMethod() throws Exception {
		...
		try {
			...
			// Create another mapper instance with a method cache we can test
			// against:
			...
			final Method selectBlogByIdUsingConstructor = BoundBlogMapper.class
					.getMethod("selectBlogByIdUsingConstructor", Integer.TYPE);
			...
			// Call another mapper method and verify that it shows up in the
			// cache as well:
			session.clearCache();
