...
public class ExecutorTestHelper {
								...
								new ArrayList<ParameterMapping>() {
...

									{
										...
										add(new ParameterMapping.Builder(config, "bio",
												registry.getTypeHandler(String.class)).jdbcType(JdbcType.VARCHAR)
														.build());
										add(new ParameterMapping.Builder(config, "favouriteSection",
												registry.getTypeHandler(Section.class)).jdbcType(JdbcType.VARCHAR)
														.build());
									}
								}).build())
	...
	public static MappedStatement prepareInsertAuthorMappedStatementWithAutoKey(final Configuration config) {
		...
		MappedStatement ms = new MappedStatement.Builder(config, "insertAuthor",
				...
				SqlCommandType.INSERT)
						...
						.cache(authorCache).keyGenerator(new Jdbc3KeyGenerator()).keyProperty("id").build();
		return ms;
	}

	public static MappedStatement prepareInsertAuthorProc(final Configuration config) {
		final TypeHandlerRegistry registry = config.getTypeHandlerRegistry();
		MappedStatement ms = new MappedStatement.Builder(config, "insertAuthorProc",
	...
	public static MappedStatement prepareSelectOneAuthorMappedStatement(final Configuration config) {
		...
		final ResultMap rm = new ResultMap.Builder(config, "defaultResultMap", Author.class,
										...
										new ArrayList<ResultMapping>() {
...

											{
												add(new ResultMapping.Builder(config, "favouriteSection",
														"favourite_section", registry.getTypeHandler(Section.class))
																.build());
												add(new ResultMapping.Builder(config, null, "not_exists", Object.class)
														.build());
											}
										}).build());
							}
										...
										new ArrayList<ResultMapping>() {
...

											{
												add(new ResultMapping.Builder(config, null, "id",
														registry.getTypeHandler(Integer.class)).javaType(int.class)
	...
	public static MappedStatement prepareSelectTwoSetsOfAuthorsProc(final Configuration config) {
		final TypeHandlerRegistry registry = config.getTypeHandlerRegistry();
		MappedStatement ms = new MappedStatement.Builder(config, "selectTwoSetsOfAuthors",
				new StaticSqlSource(config, "{call selectTwoSetsOfAuthors(?,?)}"), SqlCommandType.SELECT)
						.statementType(StatementType.CALLABLE).parameterMap(new ParameterMap.Builder(config,
								"defaultParameterMap", Author.class, new ArrayList<ParameterMapping>() {
	...
	public static MappedStatement prepareSelectAuthorViaOutParams(final Configuration config) {
		final TypeHandlerRegistry registry = config.getTypeHandlerRegistry();
		MappedStatement ms = new MappedStatement.Builder(config, "selectAuthorViaOutParams",
				new StaticSqlSource(config, "{call selectAuthorViaOutParams(?,?,?,?,?)}"), SqlCommandType.SELECT)
						...
						.resultMaps(new ArrayList<ResultMap>()).cache(authorCache).build();
		return ms;
	}
				...
				new ArrayList<ResultMapping>() {
...

					{
						add(new ResultMapping.Builder(config, "subject", "subject",
								registry.getTypeHandler(String.class)).build());
						add(new ResultMapping.Builder(config, "body", "body", registry.getTypeHandler(String.class))
								.build());
					}
				}).build();
		config.addResultMap(discriminatorResultMap);
		MappedStatement ms = new MappedStatement.Builder(config, "selectPosts",
				new StaticSqlSource(config, "SELECT FROM post"), SqlCommandType.SELECT)
						.resultMaps(new ArrayList<ResultMap>() {
								...
								add(new ResultMap.Builder(config, "defaultResultMap", HashMap.class,
										new ArrayList<ResultMapping>() {
...

											{
												...
												new ResultMapping.Builder(config, "section", "section",
														registry.getTypeHandler(String.class)).build(),
	...
	public static MappedStatement createSelectAuthorWithIDof99MappedStatement(final Configuration config) {
		...
		MappedStatement ms = new MappedStatement.Builder(config, "selectAuthor",
				new StaticSqlSource(config, "SELECT FROM author WHERE id = 99"), SqlCommandType.SELECT)
						.statementType(StatementType.STATEMENT).parameterMap(new ParameterMap.Builder(config,
								"defaultParameterMap", Author.class, new ArrayList<ParameterMapping>()).build())
						.resultMaps(new ArrayList<ResultMap>() {
	...
	public static MappedStatement prepareComplexSelectBlogMappedStatement(final Configuration config) {
		...
		final ResultMap resultMap = new ResultMap.Builder(config, "defaultResultMap", Blog.class,
				new ArrayList<ResultMapping>() {
...

					{
						...
						add(new ResultMapping.Builder(config, "title", "title", registry.getTypeHandler(String.class))
								.build());
		...
		return new MappedStatement.Builder(config, "selectBlogById", sqlSource, SqlCommandType.SELECT)
				.parameterMap(parameterMap).resultMaps(new ArrayList<ResultMap>() {
		...
		final ParameterMap parameterMap = new ParameterMap.Builder(config, "defaultParameterMap", Map.class,
				new ArrayList<ParameterMapping>() {
...

					{
						...
						add(new ParameterMapping.Builder(config, "authorId", registry.getTypeHandler(int.class))
								.build());
					}
				}).build();
		final ResultMap resultMap = new ResultMap.Builder(config, "defaultResultMap", Blog.class,
		...
		final ResultMap tagResultMap = new ResultMap.Builder(config, "tagResultMap", Tag.class,
				new ArrayList<ResultMapping>() {
...

					{
						...
						add(new ResultMapping.Builder(config, "name", "tag_name", registry.getTypeHandler(String.class))
								.build());
					}
				}).build();
		...
		final ResultMap postResultMap = new ResultMap.Builder(config, "defaultResultMap", Post.class,
				new ArrayList<ResultMapping>() {
...

					{
						...
						add(new ResultMapping.Builder(config, "comments").nestedResultMapId(commentResultMap.getId())
								.build());
					}
				}).build();
		...
		final ResultMap postResultMap = new ResultMap.Builder(config, "", Post.class, new ArrayList<ResultMapping>() {
...

			{
				...
				add(new ResultMapping.Builder(config, "section", "section", registry.getTypeHandler(Section.class))
						.build());
				add(new ResultMapping.Builder(config, "subject", "subject", registry.getTypeHandler(String.class))
						.build());
	...
	public static MappedStatement prepareInsertAuthorMappedStatementWithBeforeAutoKey(final Configuration config) {
		final TypeHandlerRegistry registry = config.getTypeHandlerRegistry();
		final ResultMap rm = new ResultMap.Builder(config, "keyResultMap", Integer.class,
		...
		MappedStatement kms = new MappedStatement.Builder(config, "insertAuthor!selectKey",
				new StaticSqlSource(config, "SELECT 123456 as id FROM SYSIBM.SYSDUMMY1"), SqlCommandType.SELECT)
						.keyProperty("id").resultMaps(new ArrayList<ResultMap>() {
		...
		MappedStatement ms = new MappedStatement.Builder(config, "insertAuthor",
				...
				SqlCommandType.INSERT)
						...
						.cache(authorCache).keyGenerator(new SelectKeyGenerator(kms, true)).keyProperty("id").build();
		return ms;
	}
