...
public class ResultLoaderMap {
	...
	public static class LoadPair implements Serializable {
		...
		private LoadPair(final String property, MetaObject metaResultObject, ResultLoader resultLoader) {
			...
			/*
			 * Save required information only if original object can be
			 * serialized.
			 */
		...
		public void load() throws SQLException {
			/*
			 * These field should not be null unless the loadpair was
			 * serialized. Yet in that case this method should not be called.
			 */
		...
		public void load(final Object userObject) throws SQLException {
			...
			/*
			 * We are using a new executor because we may be (and likely are) on
			 * a new thread and executors aren't thread safe. (Is this
			 * sufficient?)
			 *
