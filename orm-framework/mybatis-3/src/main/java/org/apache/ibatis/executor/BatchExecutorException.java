 ...
 * from any prior nested batch that executed successfully.
 * 
 * @author Jeff Butler
 */
public class BatchExecutorException extends ExecutorException {
	 ...
	 * determine exactly which statemtn of the executor caused the failure (or
	 * failures).
	 *
	 ...
	 * list for each successful sub-executor executed before the failing
	 * executor.
	 *
	...
	/*
	 * Returns the SQL statement that caused the failure (not the
	 * parameterArray)
	 *
