 ...
 * <p>
 * <p>
 * This class is <code>abstract</code> to force the programmer to extend the
 * class. <code>getMessage</code> will include nested exception information;
 * <code>printStackTrace</code> and other like methods will delegate to the
...
public abstract class AbstractNestedRuntimeException extends RuntimeException {
    ...
    /**
     * Construct a <code>AbstractNestedRuntimeException</code> with the
     ...
     *           CommonExceptionUtils.buildMessage(super.getMessage(),
     *           getCause()); }
     */
