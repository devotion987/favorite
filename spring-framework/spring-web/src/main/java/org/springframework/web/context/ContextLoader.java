...
public class ContextLoader {
    ...
    public WebApplicationContext initWebApplicationContext(ServletContext servletContext) {
        ...
        try {
            ...
            if (this.context instanceof ConfigurableWebApplicationContext) {
                ConfigurableWebApplicationContext webApplicationContext = (ConfigurableWebApplicationContext) this.context;
    ...
    protected void customizeContext(ServletContext sc, ConfigurableWebApplicationContext wac) {
        ...
        initializerClasses.forEach(initializerClass -> {
        ...
        this.contextInitializers.forEach(initializer -> initializer.initialize(wac));
    ...
    public static WebApplicationContext getCurrentWebApplicationContext() {
        ClassLoader ccl = Thread.currentThread().getContextClassLoader();
        if (ccl != null) {
            WebApplicationContext webApplicationContext = currentContextPerThread.get(ccl);
