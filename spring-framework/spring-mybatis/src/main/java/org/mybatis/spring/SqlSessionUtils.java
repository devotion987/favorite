...
public final class SqlSessionUtils {
	 ...
	 * active).
	 *
	 * Note: The DataSource used by the Environment should be synchronized with
	 * the transaction either through DataSourceTxMgr or another tx
	 * synchronization. Further assume that if an exception is thrown, whatever
	 * started the transaction will handle closing / rolling back the Connection
